...
interface Color {
  ...
  primaryGreyGreenRGBA: string;
  primarySpringGreenRGBA: string;
...
export const COLORS: Color = {
  ...
  secondaryGreyHex: '#CCCCCC',
  primaryLightGreyHex: '#52555A',
  secondaryLightGreyHex: '#AEAEAE',
  primaryWhiteHex: '#FFFFFF',
  primaryGreyGreenRGBA: 'rgba(164,165,135,0.7)',
  primarySpringGreenRGBA: 'rgba(142,143,111,0.7)',
